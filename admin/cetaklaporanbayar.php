...
//Koneksi Ke server Database
    $sql   = "SELECT * FROM request a LEFT JOIN detail_request b ON b.no_faktur = a.no_faktur LEFT JOIN tbl_barang c ON c.kd_barang = b.kd_barang WHERE a.status = 'Transaksi Sukses' AND (a.tgl_tr BETWEEN '$tgl_awal' AND '$tgl_akhir') ORDER BY $sort_by ASC";
