...
?>		
	...
	<h3 align="center">Tahun : <?php echo $_POST['awal']?> </h3>
							<table align="center" width="100%" border="1">
                                ...
                                $sql   = "
								select * from transaksi,barang where transaksi.kode_brg=barang.kode_brg and year (transaksi.tgl)='$awal' order by transaksi.id_transaksi asc
