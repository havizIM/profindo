...
?>	
	...
	<h5 align="center"  >Laporan Data Barang Keluar Tahunan </h2>
	...
	<h3 align="center">TANGGAL : <?php echo $tgl; ?></p></h3>
							<table align="center" width="100%" border="1">
                                ...
                                //Koneksi Ke server Database
                                 $sql   = "select * from tbl_barang_keluar,tbl_barang,tbl_department,admin where tbl_barang_keluar.kd_barang=tbl_barang.kd_barang AND  tbl_barang_keluar.nama=admin.nama AND admin.kd_department=tbl_department.kd_department AND tgl_keluar LIKE '$tgl%'"; 
